<template>
  <div>
    <router-link :to="{ name: 'ProductDetail', params: { id: product.id } }" class="image-container d-flex align-items-center">
      <img class="product-image-card" :src="product.image_url" onerror="this.src = 'https://www.arraymedical.com/wp-content/uploads/2018/12/product-image-placeholder.jpg'" alt="product-image">
    </router-link>
